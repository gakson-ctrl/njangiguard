...
function ShieldSvg({ size = 48, color = '#1B7A43' }) {
  return (
      ...
      <div className="bg-white rounded-3xl p-6 w-full shadow-2xl" style={{ border: '1px solid #FFCDD2' }}>
        ...
        <div className="flex justify-center mb-4">
          <div className="w-20 h-20 rounded-full flex items-center justify-center animate-pulse"
            ...
            <ShieldSvg size={44} color="#1B7A43" />
          </div>
        </div>
  ...
  return (
    <div className="flex flex-col" style={{ backgroundColor: '#FFFDF5' }}>
      ...
      <div className="p-4 flex flex-col gap-4">
        <div className="bg-white rounded-2xl px-5 py-4 flex items-center gap-3" style={{ border: '1px solid #FFE0B2' }}>
          <div className="w-12 h-12 rounded-2xl flex items-center justify-center text-2xl flex-shrink-0"
        ...
        <div className="flex flex-col items-center py-4">
          ...
          <p className="text-6xl font-black tabular-nums"
            style={{ color: isExpired ? '#1B7A43' : '#F57C00' }}>
            {mm}:{ss}
          </p>
        </div>
      ...
      {!frozen ? (
        <>
          ...
          <div className="w-full max-w-xs rounded-2xl px-5 py-4" style={{ backgroundColor: '#1A237E' }}>
            <p className="text-xs font-bold uppercase tracking-widest mb-2" style={{ color: 'rgba(255,255,255,0.55)' }}>Code USSD</p>
...
export default function Page() {
  ...
  const handleDemo = () => {
    const idx = DEMO_CYCLE.indexOf(screen);
    setScreen(DEMO_CYCLE[(idx + 1) % DEMO_CYCLE.length]);
  };
